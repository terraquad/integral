...
data class GetListS2CPayload(val type: ListType, val props: List<EntryProperty>) : CustomPayload {
    companion object {
        ...
        val codec = PacketCodec.tuple(
            ...
            enumCodec<EntryProperty>().collect(PacketCodecs.toList()),
            GetListS2CPayload::props,
            ::GetListS2CPayload,
        )!!
    }
